...
public class ClienteTCP_Robo extends JFrame implements Runnable {
			...
			try {
				...
				case conectar:
					...
					if (resposta.equals("ligado")) {
						...
						robo = new RobotLego();
						robo.OpenNXT(nome);
						mostrarMensagem("Conectado");
					} else {
						mostrarMensagem("Em espera");
					}
					break;

				case remover:

					os.println(id + ";remover;");
					break;
	...
	public static void main(String[] args) {
		ClienteTCP_Robo frame = new ClienteTCP_Robo();
		frame.run();
	}
